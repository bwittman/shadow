...
_loopBody:
	...
	%allocatedArray = call %shadow.standard..Array* @__allocateArray(%shadow.standard..GenericClass* @shadow.standard..Array_L.ubyte_R.class, %long %longLength, %boolean false)	
