...
@shadow.standard..Array_L_shadow.standard..ubyte_R.class = external constant %shadow.standard..Class ; Actually GenericClass, but this keeps LLVM happy
...
@_array0 = private unnamed_addr constant {%ulong, %shadow.standard..Class*, %shadow.standard..Array._methods*, %long, [20 x %ubyte]} {%ulong -1, %shadow.standard..Class* @shadow.standard..Array_L_shadow.standard..ubyte_R.class, %shadow.standard..Array._methods* @shadow.standard..Array._methods, %long 20, [20 x %ubyte] c"Heap space exhausted"}
